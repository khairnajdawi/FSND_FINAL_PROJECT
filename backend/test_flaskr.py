...
class CastingAgencyTestCase(unittest.TestCase):
    ...
    # test add actor, shourld return http code 200,false success with the new actor's id
    ...
    def test_add_new_actor_failure(self):
        res = self.client().post('/actors', json=self.bad_new_actor, headers=self.headers)
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 422)
        self.assertEqual(data['success'], False)

    # test get actor's info, should return http code 200,success with the actor's info object
    ...
    # test get actor's info who doesn't exist, should return http code 404, false success with the actor's info object
    ...
    # test delete actor success, should return 200 http code, success with the id of actor just deleted
    ...
    # test delete actor failure when actor doesn't exist, should return 404 http code,false success
    ...
    # test edit actor's info success, should return 200 http code, success boolean
    def test_edit_actor_info(self):
        res = self.client().patch('/actors/1', headers=self.headers,json={"name": "Will Smith"})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertTrue(data['updated'], True)

    # test edit actor's info failure when actor does not exist, should return 404 http code, success boolean false
    def test_edit_actor_info_failure(self):
        res = self.client().patch('/actors/444', headers=self.headers,json={"name": "Brad Pitt"})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 404)
        self.assertEqual(data['success'], False)

    # test edit actor's info failure when no data provided, should return 422 http code, success boolean false
    ...
    # test get actor's movies, should return 200 http code, success boolean and a list of movies
    ...
    # test get actor's movies failure when actor does not exist, should return 404 http code, success boolean false
    ...
    # test get movies list, should return 200 status code, success boolean and a list of movies
    ...
    # test get movie's info, should return 200 status code, success boolean and a info object
    ...
    # test get movie's info failure, should return 404 status code, success boolean and a info object
    ...
    # test create a new movie success, should return 200 http status code, success boolean and new movie's id
    ...
    # test create a new movie failure when no data or bad data, should return 422 http status code, success false
    def test_add_movie_failure(self):
        res = self.client().post('/movies', headers=self.headers, json=self.bad_new_movie)
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 422)
        self.assertEqual(data['success'], False)

    # test edit a movie success, should return 200 http status code, success true and the updated movie's id
    def test_edit_movie_info_success(self):
        res = self.client().patch('/movies/1', headers=self.headers, json={"title": "Am Legend"})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEqual(data['updated'], 1)

    # test edit a movie failure when movie does not exist, should return 404 http status code, success false
    def test_edit_movie_info_failure_not_exist(self):
        res = self.client().patch('/movies/11111', headers=self.headers, json={"title": "Am Legend"})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 404)
        self.assertEqual(data['success'], False)

    # test edit a movie failure when no data, should return 400 http status code, success false
    ...
    # test get movie's actors list success, should return 200 http status code, success boolean and a list of actors
    ...
    # test get movie's actors list failure if movie does not exist, should return 404 http status code, false success boolean
    ...
    def test_add_movie_actor(self):
        res = self.client().post('/movies/2/actors', headers=self.headers, json={"actor_id": 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_add_movie_actor_failure_not_exist(self):
        res = self.client().post('/movies/2222/actors', headers=self.headers, json={"actor_id": 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 404)
        self.assertEqual(data['success'], False)

    # test get movie's actors list failure if no data, should return 400 http status code, false success boolean
    ...
    # test get movie's actors list failure if actor does not exist, should return 422 http status code, false success boolean
    def test_add_movie_actor_failure_actor_not_exist(self):
        res = self.client().post('/movies/2/actors', headers=self.headers, json={"actor_id": 1111})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 422)
        self.assertEqual(data['success'], False)
    
    # test ddelete movie's actor success, should return 200 http status code, success boolean 
    ...
    # test ddelete movie's actor failure if no data, should return 400 http status code, success boolean 
    ...
    # test ddelete movie's actor failure if movie not exist, should return 404 http status code, success boolean 
    def test_delete_movie_actor_failure_movie_not_exist(self):
        res = self.client().post('/movies/222/actors', headers=self.headers, json={"actor_id": 1})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 404)
        self.assertEqual(data['success'], False)   

    # test delete movie success, should return 200 http status code, succes boolean and the id of the movie just deleted
    ...
    # test delete movie failure if movie not exist, should return 404 http status code, succes boolean false
    ...
    # #test error 404 not found when try to get questions based on not exist category
    ...
    # #test delete question failure, must return 422 if question id does not exist
